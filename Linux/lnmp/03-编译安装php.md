...
| Curl 库依赖包    | [curl-7.66.0.tar.gz](https://curl.haxx.se/download/curl-7.66.0.tar.gz)        |
| openssl 库依赖包 | [openssl-1.1.1d.tar.gz](https://www.openssl.org/source/openssl-1.1.1d.tar.gz) |
...
2. 构建选项
   ...
   --enable-mysqlnd \
   --with-pdo-mysql \
   --with-curl=/package/lnmp/curl-7.66.0 \
   --without-cdb \
   --without-sqlite3 \
   --without-pdo-sqlite
   ```
